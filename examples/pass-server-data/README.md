...
data cached from an API call) in `operations/get-item.js`. It has three routes: a home page, an item page, and a route which provides
item data. The item page uses data from the get-item operation, passed as a query parameter in `routes/item.js`.
